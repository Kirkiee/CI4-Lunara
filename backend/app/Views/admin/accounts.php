...
<body class="flex text-gray-100 min-h-screen relative">
    ...
    <main class="flex-1 p-8 overflow-y-auto relative z-10">
        ...
        <div class="mb-10">
            ...
            <p class="text-gray-300 mt-2">Manage user access and admin roles under the moonlight 🌙</p>
        </div>

        <!-- Stats Cards -->
        <div class="grid md:grid-cols-3 gap-8 mb-12">
            <div class="panel">
                <h3 class="text-[#8ecae6] font-semibold mb-2">Total Accounts</h3>
                <p class="text-4xl font-bold">238</p>
            </div>
            <div class="panel">
                <h3 class="text-[#8ecae6] font-semibold mb-2">Active Users</h3>
                <p class="text-4xl font-bold">217</p>
            </div>
            <div class="panel">
                <h3 class="text-[#8ecae6] font-semibold mb-2">Admins</h3>
        ...
        <section class="panel">
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-2xl font-bold text-[#8ecae6]">User Accounts</h3>
                <button class="btn-arctic">+ Add Account</button>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="py-3 px-4"><span class="text-[#8ecae6] font-medium">Admin</span></td>
                        ...
                        <tr>
                            ...
                            <td class="py-3 px-4"><span class="text-[#8ecae6] font-medium">Staff</span></td>
                            <td class="py-3 px-4 status-active">Active</td>
                        ...
                        <tr>
                            ...
                            <td class="py-3 px-4"><span class="text-[#a8dadc] font-medium">Customer</span></td>
                            <td class="py-3 px-4 status-pending">Pending</td>
                        ...
                        <tr>
                            ...
                            <td class="py-3 px-4"><span class="text-[#a8dadc] font-medium">Customer</span></td>
                            <td class="py-3 px-4 status-banned">Banned</td>
