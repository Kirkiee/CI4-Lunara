...
<head>
    ...
    <style>
        ...
        .strength-fill {
            ...
            background: linear-gradient(90deg, #7cd3ff, #b5e9ff, #85d4ff, #3bb0ff);
...
<body class="flex items-center justify-center min-h-screen text-gray-100 relative">
    ...
    <div class="relative z-10 bg-white/10 backdrop-blur-md p-10 rounded-2xl shadow-2xl border border-white/20 w-full max-w-2xl">
        ...
        <h2 class="text-center text-3xl font-bold mb-8 text-gradient">Join Lunara ❄️</h2>
        ...
        <form id="signupForm" action="/signup" method="POST" novalidate class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <!-- First Name -->
                <div>
                    <label class="block text-blue-200 font-semibold mb-1">First Name</label>
                    <input type="text" name="first_name" required
                        value="<?= esc($old['first_name'] ?? '') ?>"
                        class="w-full px-4 py-3 rounded-lg bg-white/20 text-white placeholder-gray-300 
                        <?= isset($errors['first_name']) ? 'border border-red-500' : 'border border-white/30' ?> focus:outline-none focus:ring-2 focus:ring-blue-400"
                ...
                <!-- Middle Name -->
                <div>
                    <label class="block text-blue-200 font-semibold mb-1">Middle Name</label>
                    <input type="text" name="middle_name"
                        value="<?= esc($old['middle_name'] ?? '') ?>"
                        class="w-full px-4 py-3 rounded-lg bg-white/20 text-white placeholder-gray-300 
                        <?= isset($errors['middle_name']) ? 'border border-red-500' : 'border border-white/30' ?> focus:outline-none focus:ring-2 focus:ring-blue-400"
                ...
                <!-- Last Name -->
                <div>
                    <label class="block text-blue-200 font-semibold mb-1">Last Name</label>
                    <input type="text" name="last_name" required
                        value="<?= esc($old['last_name'] ?? '') ?>"
                        class="w-full px-4 py-3 rounded-lg bg-white/20 text-white placeholder-gray-300 
                        <?= isset($errors['last_name']) ? 'border border-red-500' : 'border border-white/30' ?> focus:outline-none focus:ring-2 focus:ring-blue-400"
            ...
            <!-- EMAIL -->
            <div>
                <label class="block text-blue-200 font-semibold mb-1">Email Address</label>
                <input type="email" name="email" required
                    value="<?= esc($old['email'] ?? '') ?>"
                    class="w-full px-4 py-3 rounded-lg bg-white/20 text-white placeholder-gray-300 
                    <?= isset($errors['email']) ? 'border border-red-500' : 'border border-white/30' ?> focus:outline-none focus:ring-2 focus:ring-blue-400"
            ...
            <!-- PHONE -->
            <div>
                <label class="block text-blue-200 font-semibold mb-1">Phone Number</label>
                <input type="text" name="phone_number"
                    value="<?= esc($old['phone_number'] ?? '') ?>"
                    class="w-full px-4 py-3 rounded-lg bg-white/20 text-white placeholder-gray-300 
                    <?= isset($errors['phone_number']) ? 'border border-red-500' : 'border border-white/30' ?> focus:outline-none focus:ring-2 focus:ring-blue-400"
            ...
            <!-- GENDER -->
            <div>
                <label class="block text-blue-200 font-semibold mb-1">Gender</label>
                <select name="gender"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-blue-200 font-semibold mb-1">Address Line</label>
                    <input type="text" name="address_line"
                        value="<?= esc($old['address_line'] ?? '') ?>"
                        class="w-full px-4 py-3 rounded-lg bg-white/20 text-white placeholder-gray-300 border border-white/30 focus:outline-none focus:ring-2 focus:ring-blue-400"
                        placeholder="Street / House No.">
                </div>
                <div>
                    <label class="block text-blue-200 font-semibold mb-1">City</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-blue-200 font-semibold mb-1">Province</label>
                ...
                <div>
                    <label class="block text-blue-200 font-semibold mb-1">Postal Code</label>
            ...
            <!-- PASSWORD -->
            <div>
                <label class="block text-blue-200 font-semibold mb-1">Password</label>
                <div class="relative">
                    <input id="password" type="password" name="password"
                        class="w-full px-4 py-3 pr-14 rounded-lg bg-white/20 text-white placeholder-gray-300 border border-white/30 focus:outline-none focus:ring-2 focus:ring-blue-400"
                        placeholder="••••••••">
            ...
            <!-- CONFIRM PASSWORD -->
            <div>
                <label class="block text-blue-200 font-semibold mb-1">Confirm Password</label>
                <div class="relative">
            ...
            <button type="submit" id="submitBtn" disabled
                class="w-full bg-gradient-to-r from-blue-400 to-cyan-400 text-gray-100 font-semibold py-3 rounded-full hover:from-blue-500 hover:to-cyan-500 hover:shadow-lg hover:shadow-cyan-300/30 transition-all duration-200">
                Create Account
            </button>

            <p class="text-center text-gray-300 mt-6 text-sm">
                Already have an account?
                <a href="/login" class="text-blue-300 hover:text-blue-400 font-semibold">Login</a>
            </p>

            <p class="text-center mt-6">
                <a href="/" class="text-sm text-gray-400 hover:text-blue-300">← Back to Home</a>
            </p>
        </form>
